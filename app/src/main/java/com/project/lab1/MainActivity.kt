...
////    }
//
//    private fun getPastImages(): Array<FeedItem>? {
//        showProgress()
//
//        var feed_posts: Array<FeedItem>? = null
//        // Run network request in coroutine Global Scope (Background Thread)
//        GlobalScope.launch {
//            kotlin.runCatching {
//                // Request data from API
...
//                // Handle success request
//                handleAPIData(it)
////                yield return feed_posts
////                Log.d("mmm", feed_posts.toString())
//            }.onFailure {
//                // Handle failure and hide progress overlay
//                print(it)
//                MainScope().launch { hideProgress() }
...
//    }
//
//    private fun handleAPIData(data: ArrayList<Image>): Array<FeedItem>? {
...
//        if (posts == null) {
//            posts = getPastImages()
//            Log.d("dsd", posts.toString())
//
//        }

//        Log.d("ddd", posts.toString())
//        if (posts == null) {
//            posts = arrayOf(
//                FeedItem(
//                    "aka14fkr",
